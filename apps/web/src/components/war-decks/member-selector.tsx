  ...
  return (
    <div className="relative">
      <select
        ...
        className="w-full appearance-none bg-glass border border-clash-border rounded-lg px-2 py-2 text-xs sm:text-sm text-clash-text focus:outline-none focus:border-clash-primary/50 cursor-pointer"
      >
