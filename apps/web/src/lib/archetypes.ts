...
export const ARCHETYPES: Archetype[] = [
  {
    ...
    flex: [
      ["Mega Minion", "Minions", "Phoenix", "Skeleton Dragons"],
  ...
  },
  {
    ...
    flex: [
      ["Mega Minion", "Baby Dragon", "Phoenix", "Skeleton Dragons"],
  ...
  },
  {
    ...
    targetElixir: 4.2,
    elixirRange: [3.8, 4.5],
    core: ["Elixir Golem", "Battle Healer", "Night Witch", "Heal Spirit"],
    flex: [
      ["Baby Dragon", "Mega Minion", "Phoenix", "Skeleton Dragons"],
