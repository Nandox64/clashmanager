...
export const mockMembers: Member[] = [
  {
    ...
    lastActiveAt: Date.now() - 2 * 3600000,
    status: "active",
    trophies: 7800,
    bestTrophies: 8100,
    level: 58,
    warDayWins: 320,
    cardsCollected: 12500,
    donations: 15400,
    donationsReceived: 8900,
    clanPoints: 2500,
    xp: 1800,
    weeklyStats: { trophiesGained: 280, donationsGiven: 650, warParticipation: 100, activityDays: 7 },
  },
  {
    uid: "member-002",
    ...
    lastActiveAt: Date.now() - 5 * 3600000,
    status: "active",
    trophies: 7600,
    bestTrophies: 7900,
    level: 55,
    warDayWins: 280,
    cardsCollected: 11200,
    donations: 13200,
    donationsReceived: 7600,
    clanPoints: 2200,
    xp: 1600,
    weeklyStats: { trophiesGained: 320, donationsGiven: 720, warParticipation: 100, activityDays: 7 },
  },
  {
    uid: "member-003",
    ...
    lastActiveAt: Date.now() - 8 * 3600000,
    status: "active",
    trophies: 7400,
    bestTrophies: 7700,
    level: 53,
    warDayWins: 250,
    cardsCollected: 10800,
    donations: 14800,
    donationsReceived: 7200,
    clanPoints: 2100,
    xp: 1500,
    weeklyStats: { trophiesGained: 190, donationsGiven: 850, warParticipation: 100, activityDays: 7 },
  },
  {
    uid: "member-004",
    displayName: "IcePhoenix",
    email: "ice@email.com",
    photoURL: "",
    role: "veteran",
    playerTag: "#2R8P9LQW3",
    joinedAt: Date.now() - 90 * 86400000,
    lastActiveAt: Date.now() - 24 * 3600000,
    status: "active",
    trophies: 7100,
    bestTrophies: 7400,
    level: 51,
    ...
    cardsCollected: 9800,
    donations: 11200,
    donationsReceived: 6800,
    clanPoints: 1800,
    xp: 1300,
    weeklyStats: { trophiesGained: 150, donationsGiven: 500, warParticipation: 80, activityDays: 6 },
  },
  {
    uid: "member-005",
    displayName: "ThunderWolf",
    email: "thunder@email.com",
    photoURL: "",
    role: "veteran",
    playerTag: "#5H1K7MNB4",
    joinedAt: Date.now() - 60 * 86400000,
    lastActiveAt: Date.now() - 12 * 3600000,
    status: "active",
    trophies: 6800,
    bestTrophies: 7200,
    level: 49,
    ...
    cardsCollected: 9100,
    donations: 9800,
    donationsReceived: 6400,
    clanPoints: 1600,
    xp: 1100,
    weeklyStats: { trophiesGained: 210, donationsGiven: 420, warParticipation: 90, activityDays: 6 },
  },
  {
    uid: "member-006",
    ...
    cardsCollected: 8200,
    donations: 8500,
    donationsReceived: 5900,
    clanPoints: 1400,
    xp: 900,
    weeklyStats: { trophiesGained: 180, donationsGiven: 380, warParticipation: 70, activityDays: 5 },
  },
  {
    uid: "member-007",
    ...
    cardsCollected: 7500,
    donations: 6200,
    donationsReceived: 5100,
    clanPoints: 1100,
    xp: 700,
    weeklyStats: { trophiesGained: 80, donationsGiven: 150, warParticipation: 40, activityDays: 3 },
  },
  {
    uid: "member-008",
    ...
    clanPoints: 800,
    xp: 500,
    weeklyStats: { trophiesGained: 30, donationsGiven: 80, warParticipation: 20, activityDays: 1 },
  },
  {
    uid: "member-009",
    displayName: "NovaBlast",
    email: "nova@email.com",
    photoURL: "",
    role: "member",
    playerTag: "#1P5W8JKL3",
    joinedAt: Date.now() - 10 * 86400000,
    lastActiveAt: Date.now() - 96 * 3600,
    status: "inactive",
    trophies: 5700,
    bestTrophies: 6000,
    level: 42,
    ...
    clanPoints: 600,
    xp: 350,
    weeklyStats: { trophiesGained: -50, donationsGiven: 40, warParticipation: 0, activityDays: 0 },
  },
  {
    uid: "member-010",
    displayName: "CrimsonTide",
    email: "crimson@email.com",
    photoURL: "",
    role: "member",
    playerTag: "#8K3M2NXZ9",
    ...
    level: 50,
    warDayWins: 200,
    cardsCollected: 10500,
    donations: 12000,
    donationsReceived: 7000,
    clanPoints: 1900,
    xp: 1400,
    weeklyStats: { trophiesGained: 250, donationsGiven: 600, warParticipation: 90, activityDays: 6 },
  },
];
